            ...
            <div id="wizard">
                ...
                <div id="section2">
                    ...
                    <p>
                        ...
                        <input type="radio" id="surfacefirm11" name="Is the surface firm" value="12" fieldtype_id="2">Yes
                        <input type="radio" id="surfacefirm12" name="Is the surface firm" value="13" fieldtype_id="2">No
                        <input type="radio" id="surfacefirm13" name="Is the surface firm" value="14" fieldtype_id="2">Not Applicable
                    </p>
                    <p>
                ...
                <div id="section3">
                    ...
                    <p>
                        <label for="surfacefirm">Is the surface firm?</label>
                        <input type="radio" id="surfacefirm21" name="Is the surface firm" value="12" fieldtype_id="2">Yes
                        <input type="radio" id="surfacefirm22" name="Is the surface firm" value="13" fieldtype_id="2">No
                        <input type="radio" id="surfacefirm23" name="Is the surface firm" value="14" fieldtype_id="2">Not Applicable
                    </p>
                    <p>
